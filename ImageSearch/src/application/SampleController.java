...
public class SampleController {
    ...
    void display(ActionEvent event) {
    	try {
            ...
            //Display all urls
            resultLabel.setText("Text file has been created\n"
    ...
    //On help button click, open up a sub window with directions on hot to use app
    @FXML
    ...
    //Use close button to exit app
    //Alternative close option used if you can't see the x button
    @FXML
